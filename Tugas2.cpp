...
int main()
{
 ...
 float a,b ;
 int i, ulang;
 cout << "Adetya Anhar         (3411141150)" ;
 cout << endl ;
 cout << "Achmad Abdul Aziz    (3411141072)" ;
 cout << endl ;
 cout <<"APLIKASI UNTUK MENGHITUNG REGRESI LINIER" ;
 cout << endl ;
 cout << "---------------------------------------" ;
 cout << endl ;
 ...
 do
 {
    ...
    cout << endl << endl ;
 cout << "Masukkan banyak data yang ingin Anda di input : " ;
 cin >> data ;
 cout << endl ;
 ...
 cout << "Persamaan linear dari fungsi regresi di atas adalah Y=" << endl << b << "X" 
